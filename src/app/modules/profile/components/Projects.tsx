...
import {Card2} from '../../../../RTCompressor/partials/content/cards/Card2'
...
const users1: Array<IconUserModel> = [
  ...
  {name: 'Rudy Stone', avatar: '/media/avatars/profile.jpg'},
...
const users3 = [
  ...
  {name: 'Cris Willson', avatar: '/media/avatars/profile.jpg'},
