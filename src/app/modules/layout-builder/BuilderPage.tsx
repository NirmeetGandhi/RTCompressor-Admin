...
import {KTSVG, toAbsoluteUrl} from '../../../RTCompressor/helpers'
import {getLayoutFromLocalStorage, ILayout, LayoutSetup} from '../../../RTCompressor/layout/core'
        ...
        <div className='card-body d-flex align-items-center py-8'>
          ...
          <div className='ms-6'>
            ...
            <p className='list-unstyled text-gray-600 fw-bold fs-6 p-0 m-0'>
              ...
              <code>src/RTCompressor/layout/core/_LayoutConfig.ts</code> file). Don't forget clear
              your local storage when you are changing _LayoutConfig.
            </p>
          </div>
        </div>
      </div>
