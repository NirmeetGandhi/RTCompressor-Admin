            ...
            <div className='d-flex align-items-center mb-7'>
              ...
              <div className='d-flex flex-stack flex-grow-1 ms-4 ms-lg-6'>
                ...
                <div className='d-flex flex-column me-2 me-lg-5'>
                  {/* begin::Title */}
                  <a
                    href='https://preview.keenthemes.com/RTCompressor/react/docs/docs/quick-start'
            ...
            <div className='d-flex align-items-center mb-7'>
              ...
              <div className='d-flex flex-stack flex-grow-1 ms-4 ms-lg-6'>
                ...
                <div className='d-flex flex-column me-2 me-lg-5'>
                  {/* begin::Title */}
                  <a
                    href='https://preview.keenthemes.com/RTCompressor/react/docs/docs/utilities'
                    className='text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1'
                  >
                    Plugins &amp; Components
                  </a>
            ...
            <div className='d-flex align-items-center mb-7'>
              ...
              <div className='d-flex flex-stack flex-grow-1 ms-4 ms-lg-6'>
                ...
                <div className='d-flex flex-column me-2 me-lg-5'>
                  {/* begin::Title */}
                  <a
                    href='https://preview.keenthemes.com/RTCompressor/react/docs/docs/changelog'
                    className='text-dark text-hover-primary fw-bolder fs-6 fs-lg-4 mb-1'
                  >
                    What's New
                  </a>
